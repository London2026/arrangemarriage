...
export async function sendWelcomeEmail(to: string, firstName: string, userId?: string) {
  ...
  const html = wrap(`
    ...
    <div style="background:#f8f5ef;border-left:3px solid #c9a84c;padding:16px 20px;margin-bottom:20px;border-radius:0 6px 6px 0;">
      ...
      <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;margin:0 0 9px;">📸 <strong>Step 2 — Upload your photos</strong> — Back-side photos are visible to all members; your face photo stays blurred until you choose to reveal it. Once someone reveals your face photo, you will be notified right away.</p>
      ...
      <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;margin:0 0 9px;">💛 <strong>Step 5 — Like profiles you're interested in</strong> — When the other member likes you back, it's a Mutual Like — your video meeting feature is unlocked, so you can go ahead and book a video call.</p>
      <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;margin:0;">🎥 <strong>Step 6 — Meet face-to-face</strong> — Request a private video meeting with members you are interested in.</p>
    </div>
    <hr style="border:none;border-top:1px solid #f0e8d5;margin:20px 0;">
    ...
    <p style="font-family:Georgia,serif;font-size:14px;color:#5a6e82;line-height:1.9;margin:0 0 20px;">📝 <strong>चरण 1</strong> — प्रोफ़ाइल बनाएं&nbsp;&nbsp;📸 <strong>चरण 2</strong> — फ़ोटो अपलोड करें&nbsp;&nbsp;🎙 <strong>चरण 3</strong> — आवाज़ रिकॉर्ड करें&nbsp;&nbsp;🔍 <strong>चरण 4</strong> — प्रोफ़ाइल खोजें&nbsp;&nbsp;💛 <strong>चरण 5</strong> — प्रोफ़ाइल पसंद करें&nbsp;&nbsp;🎥 <strong>चरण 6</strong> — वीडियो मीटिंग करें</p>
    <div style="text-align:center;margin:20px 0 8px;">
...
export async function sendTrialEndedEmail(to: string, firstName: string, userId?: string) {
  const subject = `Your free trial has ended — upgrade to continue on Arrange Marriage`
  const html = wrap(`
    <h2 style="font-family:Georgia,serif;font-size:22px;color:#0d1f3c;margin:0 0 4px;">Your Free Trial Has Ended</h2>
    <p style="font-family:Arial,sans-serif;font-size:11px;color:#8b6914;letter-spacing:2px;text-transform:uppercase;margin:0 0 16px;">आपका निःशुल्क ट्रायल समाप्त हो गया है</p>
    <div style="height:2px;background:linear-gradient(to right,#c9a84c,transparent);margin-bottom:24px;"></div>
    <p style="font-family:Georgia,serif;font-size:16px;color:#2c4a6e;line-height:1.8;margin:0 0 16px;">Dear <strong>${firstName}</strong>,</p>
    <p style="font-family:Georgia,serif;font-size:16px;color:#0d1f3c;line-height:1.8;margin:0 0 16px;">
      Your one-month free trial of Arrange Marriage has come to an end today. You can still browse Discover, but liking profiles, revealing photos, and requesting video meetings are now paused until you upgrade.
    </p>
    <div style="background:#f8f5ef;border-left:3px solid #c9a84c;padding:16px 20px;margin-bottom:20px;border-radius:0 6px 6px 0;">
      <p style="font-family:Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#8b6914;margin:0 0 10px;">Upgrade to unlock, right away:</p>
      <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;margin:0 0 8px;">💛 Unlimited likes and photo reveals</p>
      <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;margin:0 0 8px;">📹 Video meeting requests with matches</p>
      <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;margin:0;">✨ Full access to your Discover feed</p>
    </div>
    <hr style="border:none;border-top:1px solid #f0e8d5;margin:20px 0;">
    <p style="font-family:Georgia,serif;font-size:15px;color:#0d1f3c;line-height:1.9;margin:0 0 16px;">
      प्रिय <strong>${firstName}</strong>, आपका एक महीने का निःशुल्क ट्रायल आज समाप्त हो गया है। अपनी खोज जारी रखने के लिए कृपया अभी एक सशुल्क योजना चुनें।
    </p>
    <div style="text-align:center;margin:20px 0 8px;">
      <a href="https://arrangemarriage.co.in/pricing" style="display:inline-block;padding:14px 40px;background:linear-gradient(135deg,#e8c876,#c9a84c);color:#0d1f3c;font-family:Arial,sans-serif;font-size:13px;font-weight:700;letter-spacing:2px;text-transform:uppercase;text-decoration:none;border-radius:6px;">Choose a Plan & Continue →</a>
    </div>
    <p style="font-family:Georgia,serif;font-size:13px;color:#9aabb8;text-align:center;margin:8px 0 0;font-style:italic;">We'd love to help you continue your search. — The Arrange Marriage Team</p>
  `, userId ? unsubUrl(userId) : undefined)
  await send(to, subject, html)
}
