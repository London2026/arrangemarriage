...
export default function ReferralSection({ referralCode, referralCount, planBonusUntil, userId }: {
  ...
  return (
    <div style={{ padding: 'clamp(1rem, 4vw, 1.4rem) clamp(1rem, 5vw, 1.75rem)', borderTop: `1px solid ${c.borderSub}` }}>
      ...
      <p style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '1.05rem', color: c.ivoryDim, lineHeight: 1.7, margin: '0 0 1rem' }}>
