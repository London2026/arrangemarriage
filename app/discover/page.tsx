...
export default async function DiscoverPage() {
  ...
  const PROFILE_SELECT = `
    ...
    housing, own_farm_land, disability, food_habits, smoking, alcohol, drugs, betting, hobby,
  ...
  function mapProfile(p: NonNullable<typeof ownRow>, revealFront: boolean): ProfileData {
    return {
      ...
      sexual_orientation: p.sexual_orientation ?? null, blood_group: p.blood_group ?? null,
      ...
      drugs: p.drugs ?? null, betting: p.betting ?? null,
      hobby: p.hobby ?? null,
