...
export default async function DiscoverPage() {
  ...
  const PROFILE_SELECT = `
    ...
    height, weight, rashi, sexual_orientation, brothers, sisters, father_occupation, mother_occupation,
    housing, own_farm_land, disability, food_habits, smoking, alcohol, hobby,
  ...
  function mapProfile(p: NonNullable<typeof ownRow>, revealFront: boolean): ProfileData {
    return {
      ...
      sexual_orientation: p.sexual_orientation ?? null,
      ...
      housing: p.housing ?? null, own_farm_land: p.own_farm_land ?? null, disability: p.disability ?? null,
